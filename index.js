...
loader1.load('./hope.glb', function(glb){
  console.log(glb);
...
const al = new THREE.AmbientLight(0x7F00FF, 0.3)
al.position.set(20,-10,-5)

scene.add( al )

const wl = new THREE.DirectionalLight(0x00FF7F, 0.2)
